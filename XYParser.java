...
public class XYParser extends Parser {
	...
	public static class LineContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).enterLine(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).exitLine(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XYVisitor ) return ((XYVisitor<? extends T>)visitor).visitLine(this);
	...
	public static class XContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).enterX(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).exitX(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XYVisitor ) return ((XYVisitor<? extends T>)visitor).visitX(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class YContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).enterY(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XYListener ) ((XYListener)listener).exitY(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof XYVisitor ) return ((XYVisitor<? extends T>)visitor).visitY(this);
			else return visitor.visitChildren(this);
		}
	}
